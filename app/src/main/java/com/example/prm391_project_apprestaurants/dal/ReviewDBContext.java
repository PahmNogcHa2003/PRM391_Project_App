...
public class ReviewDBContext {
    ...
    public List<Review> getReviewsByRestaurantId(int restaurantId) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM Reviews r join Users u on r.UserId = u.Id WHERE RestaurantId = ? ORDER BY CreatedAt DESC", new String[]{String.valueOf(restaurantId)});
