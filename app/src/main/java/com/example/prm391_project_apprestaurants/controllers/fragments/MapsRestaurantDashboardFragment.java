...
public class MapsRestaurantDashboardFragment extends Fragment {
    ...
    private UpdateRestaurantDashboardActivity updateRestaurantDashboardActivity;
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            mMap.setOnMapLongClickListener(latLng -> {
                ...
                isHolding = true;
                lastPos = latLng;
                updateRestaurantDashboardActivity.updatePosition(latLng.latitude, latLng.longitude);
            });
            ...
            Restaurant restaurant = updateRestaurantDashboardActivity.getUpdateRestaurant();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        updateRestaurantDashboardActivity = (UpdateRestaurantDashboardActivity) getActivity();
